...
type GetProduct = () => Promise<AxiosResponse<{ data: IProduct[]; message: string }>>;
type GetProductByCategory = (path: string) => Promise<AxiosResponse<{ data: IProduct[]; message: string }>>;
type GetProductByNsx = (path: string) => Promise<AxiosResponse<{ data: IProduct[]; message: string }>>;
